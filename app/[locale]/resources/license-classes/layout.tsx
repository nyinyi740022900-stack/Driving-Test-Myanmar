...
export async function generateMetadata({ params }: LayoutProps): Promise<Metadata> {
  ...
  return buildResourceMetadata(locale, 'resourcesLicenceClasses', '/resources/license-classes');
}
...
export default function LicenseClassesLayout({ children }: LayoutProps) {
  return (
    <>
      <AdSenseScript />
      {children}
