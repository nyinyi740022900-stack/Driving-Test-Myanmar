...
export const INSPIRED_SET_CONFIGS = {
  ...
  sg_ftt: {
    ...
    topicTargets: {
      advanced_traffic_rules: 20,
      expressway_driving: 16,
      vehicle_maintenance: 13,
      hazard_speed_management: 8,
      driver_behaviour: 5,
      defensive_driving: 6,
      eco_driving: 4,
      advanced_road_signs: 5,
      eco_driving_vehicle_maintenance: 4,
      vulnerable_road_users: 4,
      accident_procedures: 3,
      wet_weather: 2,
      special_vehicles: 2,
      night_driving: 2,
      singapore_specific: 2,
      motorcycle_rules: 1,
      advanced_parking: 1,
      fog_driving: 1,
      towing: 0,
      roundabouts: 0,
      motorcycle_safety_techniques: 0,
      motorcycle_safety_gear: 0,
      load_securing: 1,
      alcohol_drug_driving: 0,
      emergency_stop: 0,
      courteous_driving: 0,
      alcohol: 0,
      road_rage: 0,
